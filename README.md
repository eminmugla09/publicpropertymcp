...
```json
{
  ...
  "reason": "Owner name Rafael Vargas matches customer profile, the email/phone matches, and the known FPL address in Miami anchors the customer. A recent public property record shows 124 Anchorage Dr N in North Palm Beach recorded on 2026-06-15.",
  "matched_property": {
    "address": "124 Anchorage Dr N",
    "city": "North Palm Beach",
    "state": "FL",
